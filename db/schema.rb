...
ActiveRecord::Schema[7.1].define(version: 2025_12_18_051749) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.string "ainative_project_id"
    t.string "ainative_api_key_encrypted"
    t.jsonb "ainative_settings", default: {"features" => {"agent_memory" => true, "semantic_search" => true, "smart_suggestions" => true}, "auto_indexing" => true, "embeddings_model" => "BAAI/bge-small-en-v1.5", "vector_dimensions" => 384}
    t.index ["ainative_project_id"], name: "index_accounts_on_ainative_project_id", unique: true
